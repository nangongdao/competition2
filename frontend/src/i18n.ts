...
const UI_TEXT: Record<UiLanguage, UiText> = {
  'zh-CN': {
    ...
    settings: {
      ...
      unavailableTitle: '桌面设置不可用',
      unavailableBody: '请通过 Electron 桌面模式启动，浏览器模式不会读写本地密钥文件。',
      ...
      localFile: '本地文件',
      restartNotice: '翻译引擎、模型、API key 和 ASR 模式保存后，需要重启桌面应用后生效。',
      save: '保存设置',
      saving: '保存中',
      close: '关闭',
      saved: '设置已保存',
  ...
  'en-US': {
    ...
    settings: {
      ...
      unavailableTitle: 'Desktop settings unavailable',
      unavailableBody: 'Start with Electron desktop mode to read or write the local key file. Browser mode stays read-only.',
      ...
      restartNotice: 'Translation engine, model, API key, and ASR profile changes take effect after restarting the desktop app.',
      save: 'Save settings',
      saving: 'Saving',
      close: 'Close',
